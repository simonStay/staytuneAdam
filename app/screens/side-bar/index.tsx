...
class SideBar extends Component<Props, sideMenuItems, {}> {
  ...
  async componentDidMount() {
    try {
      ...
      if (
        this.props.userInfo.firstname !== undefined &&
        this.props.userInfo.lastname !== undefined
      ) {
        await this.setState({
        ...
        this.props.userInfo.profilePic !== undefined ||
        this.props.userInfo.profilePic !== "undefined"
      ) {
        await this.setState({
          profilePic: this.props.userInfo.profilePic,
  ...
  async componentWillReceiveProps(nextProps) {
    try {
      await this.setState({
        ...
        userName:
          nextProps.userProfileInfo.data.firstname + " " + nextProps.userProfileInfo.data.lastname,
      })
    } catch (error) {}
  }
